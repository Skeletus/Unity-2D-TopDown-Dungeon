...
public class ChestSpawner : MonoBehaviour
{
    ...
    private void OnValidate()
    {
        ...
        if (chestSpawnChanceByLevelList != null && chestSpawnChanceByLevelList.Count > 0)
        {
            ...
            foreach (RangeByLevel rangeByLevel in chestSpawnChanceByLevelList)
            {
                HelperUtilities.ValidateCheckNullValues(this, nameof(rangeByLevel.dungeonLevel), rangeByLevel.dungeonLevel);
        ...
        if (weaponSpawnByLevelList != null && weaponSpawnByLevelList.Count > 0)
        {
            ...
            {
                HelperUtilities.ValidateCheckNullValues(this, nameof(weaponDetailsByLevel.dungeonLevel), weaponDetailsByLevel.dungeonLevel);

                foreach (SpawnableObjectRatio<WeaponDetailsSO> weaponRatio in weaponDetailsByLevel.spawnableObjectRatioList)
                {
                    HelperUtilities.ValidateCheckNullValues(this, nameof(weaponRatio.dungeonObject), weaponRatio.dungeonObject);
