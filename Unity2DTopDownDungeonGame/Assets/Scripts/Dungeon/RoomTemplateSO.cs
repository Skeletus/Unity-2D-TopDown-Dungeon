...
public class RoomTemplateSO : ScriptableObject
{
    ...
    private void OnValidate()
    {
        ...
        if (enemiesByLevelList.Count > 0 || roomEnemySpawnParametersList.Count > 0)
        {
            ...
            {
                HelperUtilities.ValidateCheckNullValues(this, nameof(roomEnemySpawnParameters.dungeonLevel), roomEnemySpawnParameters.dungeonLevel);
                ...
                foreach (SpawnableObjectsByLevel<EnemyDetailsSO> dungeonObjectsByLevel in enemiesByLevelList)
                {
                    ...
                    HelperUtilities.ValidateCheckNullValues(this, nameof(dungeonObjectsByLevel.dungeonLevel), dungeonObjectsByLevel.dungeonLevel);

                    foreach (SpawnableObjectRatio<EnemyDetailsSO> dungeonObjectRatio in dungeonObjectsByLevel.spawnableObjectRatioList)
                    {
                        HelperUtilities.ValidateCheckNullValues(this, nameof(dungeonObjectRatio.dungeonObject), dungeonObjectRatio.dungeonObject);
